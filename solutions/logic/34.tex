...
\Def \textit{ДКА (детерменированный конечный автомат)} --- конечный автомат, у которого $\delta : G \to Q, G \subseteq Q \times \Sigma$.

\Def \textit{НКА (недетерменированный конечный автомат)} --- конечный автомат, у которого $\delta : G \to 2^Q, G \subseteq Q \times \Sigma$.
