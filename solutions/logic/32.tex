...
\begin{itemize}
    ...
    \begin{enumerate}
       ...
       \begin{figure}[H]
        ...
        То есть вида $1^{\sigma_1} + y^{\sigma_2}z^{\sigma_3} + \alpha_1 y^{\sigma_4} + \alpha_2 z^{\sigma_5}$. Уберем отрицания над переменными и получим $\alpha_0 + yz + \alpha_1 y + \alpha_2 z$. Если есть $\alpha_0 = 1$, то возьмем отрицание от всей формулы и избавимся от него.
