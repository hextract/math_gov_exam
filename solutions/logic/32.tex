...
\begin{itemize}
    ...
    \begin{enumerate}
       ...
       \begin{figure}[H]
        ...
        То есть вида $1^{\sigma_1} + y^{\sigma_2}z^{\sigma_3}$. Уберем отрицания над переменными и получим $1 + yz$ или $yz$. В первом случае заменим $y$ на $1$, а в $1 + z$ подставим исходное выражение: $1 + (1 + yz) = yz$.

        Система $0, 1, \neg, \cdot$ полна (можно составить КНФ или ДНФ, получив \texttt{or} из законов де Моргана + есть константы).
    \end{enumerate}
\end{itemize}
$\blacksquare$
