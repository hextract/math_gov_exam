...
\begin{itemize}
  ...
  \item Пусть система функций не содержится полностью ни в одном из классов Поста. Докажем, что она полна.
    ...
    \begin{enumerate}
      \item Получили $0, 1, \neg$ (если только одну константу, вторую получить тривиально) --- переходим к следующему шагу.
    ...
    $f_L(x) = a_0 + \dots a_i x_{i_1} x_{i_2} \dots x_{i_k} \dots$. Отождествим $x_{i_1} = y, x_{i_2} = z$, $x_{i_2..k} = 1$. Остальные $x_{jk} = 0$.
