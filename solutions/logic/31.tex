...
Следовательно $a^{p - 1} \cdot 1 \cdot 2 \dots (p - 1) \underset{p}{\equiv} 1 \cdot 2 \dots (p - 1)$ (т.к содержат одни и те же остатки, но возможно в разном порядке). Но $1 \cdot 2 \dots (p - 1)$ взаимнопросто с $p$. Значит $1
...
Домножим каждое на $a$ и рассмотрим остаток при делении на $n$. Т. к. $(a, n) = 1$, то все числа останутся взаимно простыми с $n$, при этом никакие не совпадают (показывается аналогично малой т. Ферма). Тогда
