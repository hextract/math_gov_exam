...
\begin{enumerate}
    \item $a \underset{p}{\equiv} a$, т. к. $a - a = 0 \vdots p$
    \item $a \underset{p}{\equiv} b \implies b \underset{p}{\equiv} a$, т. к. $(a - b) \vdots p \implies (b -a) = -(a -b) \vdots p$.
    \item $a \underset{p}{\equiv} b, b \underset{p}{\equiv} c \implies (a -b) \vdots p, (b - c) \vdots p \implies (a - b) + (b - c) = (a -c) \vdots p$
\end{enumerate}
    ...
    Следовательно $1 \cdot 2 \dots (p - 1) \underset{p}{\equiv} a^{p - 1} \cdot 1 \cdot 2 \dots (p - 1)$. Но $1 \cdot 2 \dots (p - 1)$ взаимнопросто с $p$. Значит $1 \underset{p}{\equiv} a^{p -1}$.
...
Кроме того, из $t \underset{mn}{\equiv} mx + ny$ следует $t \underset{n}{\equiv} mx$ и $t \underset{m}{\equiv} ny$. Так как $(m,n)=1$, имеем $(t,n)=1 \iff (x,n)=1$ и $(t,m)=1 \iff (y,m)=1$. Следовательно
\[
...
Домножим каждое на $a$ и рассмотрим остаток при делении на $n$. Т. к. $(a, n) = 1$, то все числа останутся взаимно простыми с $n$, при этом никакие не совпадают. Тогда $(a r_1) (a r_2) \dots (ar_{\varphi(n)}) \underset{n}{\equiv} r_1 r_2 \dots r_{\varphi(n)} \implies a^{\varphi(n)} \underset{n}{\equiv} 1$.
