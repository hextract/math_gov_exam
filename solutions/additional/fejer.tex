\subsection{(не для госа) Суммы Фейера. Равномерная сходимость суммы по Чезаро ряда Фурье}

\textit{Эта тема была затехана ошибочно, а потом оказалось, что она не нужна\dots Оставляю эту тему тут, если кому-то будет интересно.}
