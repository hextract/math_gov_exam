...
\Def Говорим, что $f$ Липшицева в $G$ по совокупности $y$ и записываем $f \in Lip_y(G)$, если $\exists L > 0\quad\forall (x, y_1), (x, y_2) \in G \hookrightarrow |f(x, y_1) - f(x, y_2)| \leq L |y_1 - y_2|$
