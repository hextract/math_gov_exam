...
\Th Пусть $v_1, \dots, v_n$ -- попарно различные собственные векторы матрицы $A$, соответствующие \textbf{необязательно попарно различным} собственным значениям
...
Так как $v_1, \dots, v_n$ линейно независимы (в частности, это верно, если они соответствуют попарно различным собственным значениям), то они образуют базис, по которому
можно разложить $x_0$:
