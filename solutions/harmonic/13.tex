...
\begin{gather*}
    ...
    \underbrace{\frac{(f(x_0-t)-f(x_0-0))+(f(x_0+t)-f(x_0+0))}{t}}_{\in L^1(0,\pi)\ \text{по условию Дини}}
    \cdot
    \underbrace{\frac{t}{2\sin(t/2)}}_{\text{непрерывно на }[0,\pi]}
    \cdot \sin\big((n+\tfrac12)t\big)\,dt.
\end{gather*}
Произведение первых двух множителей принадлежит $L^1(0,\pi)$, поэтому по лемме Римана об осцилляции интеграл стремится к нулю при $n\to\infty$.
