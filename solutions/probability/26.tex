...
\begin{equation*}
  \varphi_\xi'(t) = \frac{d}{dt} \int\limits_{\R} e^{itx} p(x) dx = \int\limits_{\R} \frac{d e^{itx}}{dt} p(x) dx = \int\limits_{\R} ix e^{itx} p(x) dx = i
  \int\limits_{\R} x e^{itx} p(x) dx = i \mathbb{E} \left[\xi e^{it\xi}\right]
\end{equation*}
...
\begin{equation*}
  \varphi_\xi(t) = 1 + \varphi_\xi'(0) t +\varphi_\xi''(0) \frac{t^2}{2} + o(t^2) \overset{t \to 0}{=} \left\{ \varphi_\xi^{(n)}(t) = i^n \mathbb{E}\left[\xi^n
  e^{it\xi}\right] \right\}  \overset{t \to 0}{=} 1 + it \mathbb{E}\xi - \frac{t^2}{2} \mathbb{E} \xi^2 + o\left(t^2\right), t \to 0
\end{equation*}
