...
\Def Компактом $K \subset \R$ будем называть множество, если из каждой числовой последовательности в нём можно выделить сходящуюся подпоследовательность, сходящуюся к элементу этого же множества.

\Theor{Эквивалентные определения компакта} Пусть $K \subset \R$. Тогда следующие условия эквивалентны:
\begin{enumerate}
    \item $K$ - компакт
    \item $K$ - ограниченное и замкнутое множество
\end{enumerate}
