...
\Def Компактом $K \subset \R$ будем называть множество, если из каждой числовой последовательности в нём можно выделить сходяющуюся числовую подпоследовательность сходяющуюся в нём же.

\Theor{Эквивалентые определения компакта} Пусть $K \subset \R$. Тогда следующие услвоия эквивалентны:
\begin{enumerate}
    \item $K$ - компакт
