...
\Def Будем говорить, что $f: U_{\delta_0} (x_0) \to \R$ диффернцируема в точке $x_0$ $\iff$ $\exists f'(x_0) \in \R$.
...
По определнию локального минимума, $\exists \delta_0 > 0: \forall x \in U_{\delta_0}(x_0) \hookrightarrow f(x) \geq f(x_0) \iff f(x) - f(x_0) \geq 0$.
...
\Def Пусть $f: U_{\delta_0} (x_0) \to \R$. Будем говорить, что $x_0$ - точка локального экстремума, если и только если они точка локального минимума, либо максимума.

\Theor{Ферма} Пусть $f: U_{\delta_0} (x_0) \to \R$ диффернцируема в $x_0$. Тогда коль скоро $x_0$ - точка локального экстремума, то $f'(x_0) = 0$.

\Proof

Для определённости будем считать, что $x_0$ - точка локального максимума (для минимума аналогично).

$f$ диффернцируема в $x_0$, тогда $0 \leq f'_-(x_0) = f'(x_0) = f'_+(x_0) \leq 0 \Rightarrow f'(x_0) = 0$.
...
\Theor{Ролля о среднем} Пусть $f \in C([a, b], \R)$, $f$ - диффернцируема на $(a, b)$, а также $f(a) = f(b)$. 
...
В силу непрерывности на отрезке, $f$ достигает наибольшего значения на нём, обозначим эту точку $\xi \in [a, b]$. $\xi$ - является точкой локального экстремума для $f$ и в силу диффернцируемости на интервале, по теореме Ферма, получаем $f'(\xi) = 0$.

\Endproof

\Theor{Коши о среднем} Пусть $f, g \in C([a, b], \R)$, $f, g$ - диффернцируемы на $(a, b)$. Также $\forall x \in (a, b) \hookrightarrow g'(x) \neq 0$. 
...
\Theor{Лангранжа о среднем} Пусть $f in C([a, b], \R)$, $f, g$ - диффернцируемы на $(a, b)$.
