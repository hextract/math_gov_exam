...
В силу непрерывности на отрезке, $f$ достигает наибольшего и наименьшего значений на $[a,b]$. Так как $f(a)=f(b)$ и $f$ не константа, хотя бы одна из точек достижения
max/min лежит внутри $(a,b)$; обозначим её $\xi\in(a,b)$. Тогда $\xi$ — точка локального экстремума и по теореме Ферма $f'(\xi)=0$.
...
\begin{multline*}
  h(a) = f(a) - \frac{f(b) - f(a)}{g(b) - g(a)} g(a) = \frac{f(a) g(b) - f(a) g(a) - g(a) f(b) + g(a) f(a)}{g(b) - g(a)} = \frac{g(b)f(a) - g(a) f(b)}{g(b) - g(a)} = \\
