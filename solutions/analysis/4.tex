...
\Theor{Коши о среднем} Пусть $f, g \in C([a, b], \R)$, $f, g$ - дифференцируемы на $(a, b)$. Также $\forall x \in (a, b) \hookrightarrow g'(x) \neq 0$. 
...
\Theor{Лагранжа о среднем} Пусть $f \in C([a, b], \R)$, $f, g$ - дифференцируемы на $(a, b)$.
