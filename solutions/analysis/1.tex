...
Но в $\mathcal{I}^n$ содержатся значения бесконечного количества элементов $\{x_n\}$. А значит и в $U_\varepsilon(x^*)$ в частности. Получается, что $\forall \varepsilon > 0$ в $U_\varepsilon(x^*)$ содержатся значения бесконечного количества элементов $\{x_n\}$.
