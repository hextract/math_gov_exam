...
\subsubsection{Необходимое условие безусловного эктремума}
...
\subsubsection{Достаточное условие безусловного эктремума}
...
В достаточно малой окрестности о-малое будет достаточно мало, чтобы $\forall x \in B_{\hat{\delta}} (x^0) \hookrightarrow f(x) \geq f(x^0) + \frac{1}{4} m ||x-x^0||^2$.
...
\textit{Примеры по 4-му пункту: $f_1(x_1, x_2) = x_1^4$, $f_2(x_1, x_2) = x_1^3$. В обоих случаях квадратичные формы зануляются в $(0, 0)$, но в одном случае это точка экстремума, а в другом нет.}
