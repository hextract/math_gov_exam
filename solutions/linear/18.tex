...
\textbf{Доказательство $\Leftarrow$} В одну сторону очевидно, \st{и в другую тоже очевидно}, в базисе из собственных векторов матрица $A$ симметрична, а значит, преобразование самосопряжено.
