...
Уравнение $2$ можно записать в общей декартовой системе координат в виде $(\mathbf{r}, \mathbf{n}) = D$.

Если уравнение $1$ записать в общей декартовой системе координат, то можно получить параметрическое уравнение прямой на плоскости.
\begin{equation}
...
При этом уравнение $(10)$ можно записать в виде $(\mathbf{r}, \mathbf{n})=D$, а уравнение $(9)$ в виде $(\mathbf{r} - \mathbf{r}_0, \mathbf{a}, \mathbf{b}) = 0$. Последнее уравнение в координатной форме равносильно уравнению
...
Расстояние от точки с радиус-вектором $\mathbf{r}_1$ до плоскости, заданной уравнением $(10)$ равно
\begin{equation*}
    \frac{(\mathbf{r}_1-\mathbf{r}_0, \mathbf{n})}{|\mathbf{n}|}
\end{equation*}

Расстояние от точки $M(x_1, y_1, z_1)$ до плоскости, заданной в прямоугольной системе координат уравнением $(11)$ равно
\begin{equation*}
...
Если уравнение $(13)$ записать в общей декартовой системе координат, то получим параметрические уравнения прямой линии:
\begin{equation*}
...
\begin{equation*}
    \cos(\phi) = |\frac{(\mathbf{a}, \mathbf{b})}{|\mathbf{a}| \cdot |\mathbf{b}|}|
\end{equation*}
