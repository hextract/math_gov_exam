...
\subsubsection{17. ОМП для равномерного распределения}

\textbf{Условие.} Найти оценку по методу максимального правдоподобия параметров $\theta_1$ и $\theta_2$ в случае, когда элементы выборки $X_1, \ldots, X_n$ имеют
равномерное распределение на отрезке $[\theta_1, \theta_2]$.
...
\subsubsection{18. ОММ для равномерного распределения}

\textbf{Условие.} Найти оценку по методу моментов параметров $\theta_1$ и $\theta_2$ в случае, когда элементы выборки $X_1, \ldots, X_n$ имеют равномерное распределение
на отрезке $[\theta_1, \theta_2]$.
